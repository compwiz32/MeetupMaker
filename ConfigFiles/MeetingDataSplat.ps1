$MeetingInfoSplat = @{
    ...
    Description = @"
Testing, testing... Is thing on? Jokes aside, you know that you should be testing your code before it goes into production. If you are scratching your head on how to test your code or why you even need to test, then this meeting is for you!
